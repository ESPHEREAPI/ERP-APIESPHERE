...
@NamedQueries({
    @NamedQuery(name = "MotifsAnnulation.findAll", query = "SELECT m FROM MotifsAnnulation m")})
public class MotifsAnnulation implements Serializable {
    ...
    public MotifsAnnulation() {
    }

    public MotifsAnnulation(String codmotan) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MotifsAnnulation)) {
            return false;
        }
        MotifsAnnulation other = (MotifsAnnulation) object;
    ...
    public String toString() {
        return "service_administration_api.entite.MotifsAnnulation[ codmotan=" + codmotan + " ]";
    }
