...
@NamedQueries({
    @NamedQuery(name = "ReductionAutomobile_1.findAll", query = "SELECT r FROM ReductionAutomobile_1 r")})
public class ReductionAutomobile_1 implements Serializable {
    ...
    public ReductionAutomobile_1() {
    }

    public ReductionAutomobile_1(String coderedu) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReductionAutomobile_1)) {
            return false;
        }
        ReductionAutomobile_1 other = (ReductionAutomobile_1) object;
    ...
    public String toString() {
        return "service_administration_api.entite.ReductionAutomobile_1[ coderedu=" + coderedu + " ]";
    }
