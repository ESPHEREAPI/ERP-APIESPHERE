...
@NamedQueries({
    @NamedQuery(name = "PeriodicitePrime_1.findAll", query = "SELECT p FROM PeriodicitePrime_1 p")})
public class PeriodicitePrime_1 implements Serializable {
    ...
    public PeriodicitePrime_1() {
    }

    public PeriodicitePrime_1(String codeperi) {
        this.codeperi = codeperi;
    }

    public PeriodicitePrime_1(String codeperi, short nombfrac) {
        this.codeperi = codeperi;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PeriodicitePrime_1)) {
            return false;
        }
        PeriodicitePrime_1 other = (PeriodicitePrime_1) object;
    ...
    public String toString() {
        return "service_administration_api.entite.PeriodicitePrime_1[ codeperi=" + codeperi + " ]";
    }
