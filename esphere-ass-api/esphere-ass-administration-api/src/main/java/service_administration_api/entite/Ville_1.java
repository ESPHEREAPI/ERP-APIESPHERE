...
public class Ville_1 implements Serializable {
    ...
    @ManyToOne
    private Region_1 coderegi;

    public Ville_1() {
    }

    public Ville_1(Integer codevill) {
    ...
    public Region_1 getCoderegi() {
        return coderegi;
    }

    public void setCoderegi(Region_1 coderegi) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Ville_1)) {
            return false;
        }
        Ville_1 other = (Ville_1) object;
    ...
    public String toString() {
        return "service_administration_api.entite.Ville_1[ codevill=" + codevill + " ]";
    }
