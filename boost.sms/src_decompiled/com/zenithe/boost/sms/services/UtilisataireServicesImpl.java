...
implements UtilisataireServices {
    ...
    public UtilisateurDto getUser(int userId) throws UtilisateurException {
        Utilisateur user = (Utilisateur)this.utilisateurRepository.findById((Object)userId).orElseThrow(() -> new UtilisateurException("USER NOT EXISTS... PLEASE TRY AGAINST"));
