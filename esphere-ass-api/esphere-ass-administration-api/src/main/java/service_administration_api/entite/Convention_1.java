...
@NamedQueries({
    @NamedQuery(name = "Convention_1.findAll", query = "SELECT c FROM Convention_1 c")})
public class Convention_1 implements Serializable {
    ...
    public Convention_1(String codeconv) {
    ...
    public TypeTarif_1 getCodtypta() {
        return codtypta;
    }

    public void setCodtypta(TypeTarif_1 codtypta) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Convention_1)) {
            return false;
        }
        Convention_1 other = (Convention_1) object;
    ...
    public String toString() {
        return "service_administration_api.entite.Convention_1[ codeconv=" + codeconv + " ]";
    }
