...
@NamedQueries({
    @NamedQuery(name = "Apporteur_1.findAll", query = "SELECT a FROM Apporteur_1 a")})
public class Apporteur_1 implements Serializable {
    ...
    @ManyToOne
    private Apporteur_1 lienappo;
    @JoinColumn(name = "CODTYPAP", referencedColumnName = "CODTYPAP")
    @ManyToOne
    private TypeApporteur_1 codtypap;
    ...
    public Apporteur_1(Integer codeappo) {
        this.codeappo = codeappo;
    }

    public Apporteur_1(Integer codeappo, String raissoci) {
        this.codeappo = codeappo;
    ...
    public Apporteur_1 getLienappo() {
        return lienappo;
    }

    public void setLienappo(Apporteur_1 lienappo) {
        this.lienappo = lienappo;
    }

    public TypeApporteur_1 getCodtypap() {
        return codtypap;
    }

    public void setCodtypap(TypeApporteur_1 codtypap) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Apporteur_1)) {
            return false;
        }
        Apporteur_1 other = (Apporteur_1) object;
    ...
    public String toString() {
        return "service_administration_api.entite.Apporteur_1[ codeappo=" + codeappo + " ]";
    }
