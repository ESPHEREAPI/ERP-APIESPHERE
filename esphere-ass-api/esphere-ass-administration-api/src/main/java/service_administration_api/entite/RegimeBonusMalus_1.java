...
@NamedQueries({
    @NamedQuery(name = "RegimeBonusMalus_1.findAll", query = "SELECT r FROM RegimeBonusMalus_1 r")})
public class RegimeBonusMalus_1 implements Serializable {
    ...
    public RegimeBonusMalus_1() {
    }

    public RegimeBonusMalus_1(String codregbm) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RegimeBonusMalus_1)) {
            return false;
        }
        RegimeBonusMalus_1 other = (RegimeBonusMalus_1) object;
    ...
    public String toString() {
        return "service_administration_api.entite.RegimeBonusMalus_1[ codregbm=" + codregbm + " ]";
    }
