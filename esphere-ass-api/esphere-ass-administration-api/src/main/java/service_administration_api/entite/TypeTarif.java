...
@NamedQueries({
    @NamedQuery(name = "TypeTarif.findAll", query = "SELECT t FROM TypeTarif t")})
public class TypeTarif implements Serializable {
    ...
    public TypeTarif(String codtypta) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TypeTarif)) {
            return false;
        }
        TypeTarif other = (TypeTarif) object;
    ...
    public String toString() {
        return "service_administration_api.entite.TypeTarif[ codtypta=" + codtypta + " ]";
    }
