...
@Table(name = "QUALITE")
@NamedQueries({
    @NamedQuery(name = "Qualite_1.findAll", query = "SELECT q FROM Qualite_1 q")})
public class Qualite_1 implements Serializable {
    ...
    public Qualite_1(Short codequal) {
        this.codequal = codequal;
    }

    public Qualite_1(Short codequal, String genrassu) {
        this.codequal = codequal;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Qualite_1)) {
            return false;
        }
        Qualite_1 other = (Qualite_1) object;
    ...
    public String toString() {
        return "service_administration_api.entite.Qualite_1[ codequal=" + codequal + " ]";
    }
