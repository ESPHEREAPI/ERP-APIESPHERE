...
public class Assure implements Serializable {
    ...
    public Assure(Long codeassu) {
        this.codeassu = codeassu;
    }

    public Assure(Long codeassu, String genrassu) {
        this.codeassu = codeassu;
    ...
    public List<Assure> getAssureList1() {
        return assureList1;
    }

    public void setAssureList1(List<Assure> assureList1) {
    ...
    public Activite getCodeacti() {
        return codeacti;
    }

    public void setCodeacti(Activite codeacti) {
        this.codeacti = codeacti;
    }

    public List<Assure> getAssureList2() {
        return assureList2;
    }

    public void setAssureList2(List<Assure> assureList2) {
        this.assureList2 = assureList2;
    }

    public Assure getGrouassu() {
        return grouassu;
    }

    public void setGrouassu(Assure grouassu) {
        this.grouassu = grouassu;
    }

    public Categoriesocioprof getCocasopr() {
        return cocasopr;
    }

    public void setCocasopr(Categoriesocioprof cocasopr) {
    ...
    public Profession getCodeprof() {
        return codeprof;
    }

    public void setCodeprof(Profession codeprof) {
        this.codeprof = codeprof;
    }

    public Qualite getCodequal() {
        return codequal;
    }

    public void setCodequal(Qualite codequal) {
    ...
    public String toString() {
        return "service_administration_api.entite.Assure[ codeassu=" + codeassu + " ]";
    }
