...
@Component({
  selector: 'app-historique-resiliations',
  standalone: true,
  imports: [CommonModule, FormsModule, TranslatePipe],
  templateUrl: './historique-resiliations.component.html',
  styleUrl: './historique-resiliations.component.css'
})
export class HistoriqueResiliationsComponent implements OnInit {
  historique: any[] = [];
  filtered:   any[] = [];
  search = '';
  isLoading = true;
