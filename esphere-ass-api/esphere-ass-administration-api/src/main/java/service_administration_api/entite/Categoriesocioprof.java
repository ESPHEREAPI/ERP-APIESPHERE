...
@NamedQueries({
    @NamedQuery(name = "Categoriesocioprof.findAll", query = "SELECT c FROM Categoriesocioprof c")})
public class Categoriesocioprof implements Serializable {
    ...
    public Categoriesocioprof() {
    }

    public Categoriesocioprof(String cocasopr) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Categoriesocioprof)) {
            return false;
        }
        Categoriesocioprof other = (Categoriesocioprof) object;
    ...
    public String toString() {
        return "service_administration_api.entite.Categoriesocioprof[ cocasopr=" + cocasopr + " ]";
    }
