...
@NamedQueries({
    @NamedQuery(name = "TimbreDimension.findAll", query = "SELECT t FROM TimbreDimension t")})
public class TimbreDimension implements Serializable {
    ...
    public TimbreDimension() {
    }

    public TimbreDimension(String codtimdi) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TimbreDimension)) {
            return false;
        }
        TimbreDimension other = (TimbreDimension) object;
    ...
    public String toString() {
        return "service_administration_api.entite.TimbreDimension[ codtimdi=" + codtimdi + " ]";
    }
