...
@Table(name = "DUREE")
@NamedQueries({
    @NamedQuery(name = "Duree_1.findAll", query = "SELECT d FROM Duree_1 d")})
public class Duree_1 implements Serializable {
    ...
    public Duree_1(String codedure) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Duree_1)) {
            return false;
        }
        Duree_1 other = (Duree_1) object;
    ...
    public String toString() {
        return "service_administration_api.entite.Duree_1[ codedure=" + codedure + " ]";
    }
