...
@NamedQueries({
    @NamedQuery(name = "Exoneration_1.findAll", query = "SELECT e FROM Exoneration_1 e")})
public class Exoneration_1 implements Serializable {
    ...
    public Exoneration_1() {
    }

    public Exoneration_1(String flaexotg) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Exoneration_1)) {
            return false;
        }
        Exoneration_1 other = (Exoneration_1) object;
    ...
    public String toString() {
        return "service_administration_api.entite.Exoneration_1[ flaexotg=" + flaexotg + " ]";
    }
