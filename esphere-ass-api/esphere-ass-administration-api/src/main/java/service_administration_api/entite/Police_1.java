...
@Table(name = "POLICE")
@NamedQueries({
    @NamedQuery(name = "Police_1.findAll", query = "SELECT p FROM Police_1 p")})
public class Police_1 implements Serializable {
    ...
    public Date getDateanni() {
        return dateanni;
    }

    public void setDateanni(Date dateanni) {
    ...
    public List<AttestationRisque> getAttestationRisqueList() {
        return attestationRisqueList;
    }

    public void setAttestationRisqueList(List<AttestationRisque> attestationRisqueList) {
        this.attestationRisqueList = attestationRisqueList;
    }

    public Convention_1 getCodeconv() {
        return codeconv;
    }

    public void setCodeconv(Convention_1 codeconv) {
        this.codeconv = codeconv;
    }

    public Apporteur_1 getCodeappo() {
        return codeappo;
    }

    public void setCodeappo(Apporteur_1 codeappo) {
        this.codeappo = codeappo;
    }

    public Assure_1 getCodeassu() {
        return codeassu;
    }

    public void setCodeassu(Assure_1 codeassu) {
        this.codeassu = codeassu;
    }

    public AsvCodeDevise_1 getCodedevi() {
        return codedevi;
    }

    public void setCodedevi(AsvCodeDevise_1 codedevi) {
    ...
    public Duree_1 getCodedure() {
        return codedure;
    }

    public void setCodedure(Duree_1 codedure) {
        this.codedure = codedure;
    }

    public Exoneration_1 getFlaexotg() {
        return flaexotg;
    }

    public void setFlaexotg(Exoneration_1 flaexotg) {
        this.flaexotg = flaexotg;
    }

    public TimbreDimension_1 getCodtimdi() {
        return codtimdi;
    }

    public void setCodtimdi(TimbreDimension_1 codtimdi) {
        this.codtimdi = codtimdi;
    }

    public MotifsAnnulation_1 getCodmotan() {
        return codmotan;
    }

    public void setCodmotan(MotifsAnnulation_1 codmotan) {
        this.codmotan = codmotan;
    }

    public PeriodicitePrime_1 getCodeperi() {
        return codeperi;
    }

    public void setCodeperi(PeriodicitePrime_1 codeperi) {
        this.codeperi = codeperi;
    }

    public ReductionAutomobile_1 getCoderedu() {
        return coderedu;
    }

    public void setCoderedu(ReductionAutomobile_1 coderedu) {
        this.coderedu = coderedu;
    }

    public RegimeBonusMalus_1 getCodregbm() {
        return codregbm;
    }

    public void setCodregbm(RegimeBonusMalus_1 codregbm) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Police_1)) {
            return false;
        }
        Police_1 other = (Police_1) object;
    ...
    public String toString() {
        return "service_administration_api.entite.Police_1[ policePK=" + policePK + " ]";
    }
