...
@NamedQueries({
    @NamedQuery(name = "AsvCodeDevise_1.findAll", query = "SELECT a FROM AsvCodeDevise_1 a")})
public class AsvCodeDevise_1 implements Serializable {
    ...
    public AsvCodeDevise_1() {
    }

    public AsvCodeDevise_1(String codedevi) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AsvCodeDevise_1)) {
            return false;
        }
        AsvCodeDevise_1 other = (AsvCodeDevise_1) object;
    ...
    public String toString() {
        return "service_administration_api.entite.AsvCodeDevise_1[ codedevi=" + codedevi + " ]";
    }
